        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              {
                title: 'Imparcialidad',
                description: 'Actuamos con objetividad y neutralidad en todos los procesos.'
              },
              {
                title: 'Confidencialidad',
                description: 'Protegemos la privacidad de todos los involucrados.'
              },
              {
                title: 'Eficacia',
                description: 'Buscamos soluciones efectivas y oportunas.'
              },
              {
                title: 'Respeto',
